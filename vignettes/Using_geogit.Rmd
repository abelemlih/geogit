...
`geogit` is a package that aims to facilitate retrieving tidy Github data to explore open source development within a specific location. The functions within this package are designed to facilitate importing information about users and repositories using the GitHub API.
...
The code chunk above was disabled because of the rate limit of the unautheticated token. It is recommended to use a personal access token from GitHub before running the code chunk above.
